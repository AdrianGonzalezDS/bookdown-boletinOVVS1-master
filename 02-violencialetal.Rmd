...
```{r victimasdelhisexoedadpir, echo=FALSE, out.width="10%",warning=FALSE,cache=F,fig.cap = '(ref:victimasdeledadsexo)'}
...
```{r victimasmilsexoedadpir, echo=FALSE, out.width="50%",warning=FALSE,cache=F,fig.cap = '(ref:victimasmiledadsexo)'}
par(mar = c(4, 4, 0.1, 0.1))
