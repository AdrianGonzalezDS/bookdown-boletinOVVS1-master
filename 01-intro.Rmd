...
knitr::kable(
  ...
  caption = "Número de víctimas por violencia letal y no letal discriminada según entidad federal donde la cobertura mediatica registró el suceso.")
```

```{r ft.align = "justify", tab.cap='Número de víctimas por violencia letal y no letal discriminada según entidad federal donde la cobertura mediática registró el suceso.', tab.id='tab3', label='tab3'}
