...
```{r victimasgenestados, results='hide',echo=FALSE,message=FALSE, warning=FALSE,cache=F}
source("sucesosvicviolencia_estados_barras.R", echo = F,local = knitr::knit_global())

```

```{r victimasgenestadosbarras, echo=FALSE, fig.width = 3, fig.asp = 0.7,out.width='90%',warning=FALSE,cache=F,fig.cap = 'Número de víctimas por violencia letal y no letal discriminadas según la entidad federal donde la cobertura mediática registro el suceso.'}
par(mar = c(4, 4, 0.1, 0.1))
knitr::include_graphics(c("images/sucesosvicestados_barras.png"))
# par(mar = c(4, 4, 0.1, 0.1))
# plot(a)
...
knitr::kable(
  tabla_sucesosvicestados, booktabs = T,align = "lcr",
  caption = "Número de víctimas por violencia letal y no letal discriminada según la entidad federal donde la cobertura mediatica registro el suceso.")
```

```{r ft.align="center", tab.cap='Número de víctimas por violencia letal y no letal discriminada según la entidad federal donde la cobertura mediática registro el suceso.', tab.id='tab3', label='tab3'}
