...
sucesosotrosdel_sel$tipo_delito <- str_replace_all(sucesosotrosdel_sel$tipo_delito,
                                                         "Agresi n  incluye lesiones graves o leves  etc ","Agresiones graves o leves")
sucesosotrosdel_sel$tipo_delito <- str_replace_all(sucesosotrosdel_sel$tipo_delito,
                                                         "Violaci n sexual","Violación sexual")

sucesosotrosdel_sel$tipo_delito <- str_replace_all(sucesosotrosdel_sel$tipo_delito,
                                                         "Coacci n  incluye extorsi n","Coacción | extorsión")
sucesosotrosdel_sel$tipo_delito <- str_replace_all(sucesosotrosdel_sel$tipo_delito,
                                                         "Amenaza de agresi n","Amenaza agresión")
sucesosotrosdel_sel$tipo_delito <- str_replace_all(sucesosotrosdel_sel$tipo_delito,
                                                         "Desaparici n forzada","Desap. forzada")
sucesosotrosdel_sel$tipo_delito <- str_replace_all(sucesosotrosdel_sel$tipo_delito,
                                                       "Tentativa de homicidio intencional","Tent. hom. intencional")
sucesosotrosdel_sel$tipo_delito <- str_replace_all(sucesosotrosdel_sel$tipo_delito,
                                                   "Otras agresiones sexuales","Otras agr. sexuales")
